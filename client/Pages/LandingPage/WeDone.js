...
export default function WeDone() {
  return (
    <section>
      ...
      <div className="bg-white flex flex-wrap justify-center gap-x-3 mb-8">
        <div className="max-w-xs">
          ...
          <div className="text-center font-bold my-4 bg-red-500 text-white rounded-t-full py-1 text-2xl">Order by Pone.</div>
          <div className="text-center bg-red-500 px-3 py-2 text-white rounded-b-full">Just take a seat, get your phone and click your wanted car.</div>
        </div>
        <div className="max-w-xs">
